...
public class CallableStatement implements java.sql.CallableStatement {
    ...
    public void addBatch(String SQL) throws SQLException {
        Observability.RoundtripTrackingSpan span = Observability.createRoundtripTrackingSpan("java.sql.CallableStatement.addBatch",
                                                                                             "addBatch",
    ...
    public boolean execute(String SQL) throws SQLException {
        Observability.RoundtripTrackingSpan span = Observability.createRoundtripTrackingSpan("java.sql.CallableStatement.execute",
                                                                                             "execute",
                                                                                             this.shouldAnnotateSpansWithSQL,
                                                                                             SQL);
    ...
    public java.sql.ResultSet executeQuery(String SQL) throws SQLException {
        Observability.RoundtripTrackingSpan span = Observability.createRoundtripTrackingSpan("java.sql.CallableStatement.executeQuery",
                                                                                             "executeQuery",
                                                                                             this.shouldAnnotateSpansWithSQL,
                                                                                             SQL);
    ...
    public int executeUpdate(String SQL) throws SQLException {
        Observability.RoundtripTrackingSpan span = Observability.createRoundtripTrackingSpan("java.sql.CallableStatement.executeUpdate",
                                                                                             "executeUpdate",
                                                                                             this.shouldAnnotateSpansWithSQL,
                                                                                             SQL);
